...
<head>
	<title>KSMS || Manage Products</title>
						...
						<table class="table table-bordered">
							<thead>
								<tr>
									...
									<th>Product Name</th>
									<th>Product Price</th>
									<th>Added into the Stock Date</th>
									<th>Action</th>
								</tr>
							</thead>
							<tbody>
								...
								<tr>
									...
									<td><img src="<?php echo $row['product_image'];?>" width="100px" height="100px">
									</td>
									<td><?php  echo $row['ProductName'];?></td>
									<td><?php  echo $row['retail_rate'];?></td>
									<td><?php  echo $row['CreationDate'];?></td>
									<td>
										<a href="edit-products.php?editid=<?php echo $row['ID'];?>">
