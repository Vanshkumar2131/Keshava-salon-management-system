...
<html>
<head>
<title>KSMS || View Appointment</title>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
            ...
            ?>
              ...
              <tr>
                <th>Salon Phone</th>
                <td><?php  echo $row['salon_phone'];?></td>
              </tr>
              <tr>
                <th>Salon Email</th>
              ...
              <form name="submit" method="post" enctype="multipart/form-data"> 
                ...
                <tr align="center">
                  <td colspan="2">
                    <button type="submit" name="submit" class="btn btn-primary btn-sm" style="margin-top: 67px; font-size: 17px; width: 83px; height: 53px;">Submit</button>
                  </td>
                </tr>
              </form>
              <?php } else { ?>
