...
<html>
<head>
<title>KSMS || Search Invoice</title>
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1" style="
    color: white;
    margin-bottom: 24px;
">Search by Invoice Number or Billing Number :-</label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" style="
    height: 40px;
">
