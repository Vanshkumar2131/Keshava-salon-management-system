<style type="text/css">
  ...
  <div class=" sidebar" role="navigation">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1" style="
    margin-top: 10px;
">
          <ul class="nav" id="leftCol" style="margin-top:7% ;">
            ...
            <li>
              <a href="add-products.php"><i class="fa fa-cogs nav_icon"></i>Products<span class="fa arrow" style="
    margin: 3px;
"></span> </a>
            ...
            <li>
              <a href="add-services.php"><i class="fa fa-cogs nav_icon"></i>Services<span class="fa arrow" style="
    margin: 3px;
"></span> </a>
              <ul class="nav nav-second-level collapse">
                <li>
            ...
            <li class="">
              <a href="about-us.php"><i class="fa fa-book nav_icon"></i>Pages <span class="fa arrow" style="
    margin: 3px;
"></span></a>
              <ul class="nav nav-second-level collapse">
                <li>
            ...
            <li>
              <a href="all-appointment.php"><i class="fa fa-check-square-o nav_icon"></i>Appointment<span class="fa arrow" style="
    margin: 3px;
"></span></a>
              <ul class="nav nav-second-level collapse">
                <li>
