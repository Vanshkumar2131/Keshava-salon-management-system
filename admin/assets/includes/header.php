<div class="sticky-header header-section ">
      <div class="header-left">
        <!--toggle button start-->
        <button id="showLeftPush" style="height:85px;"><i class="fa fa-bars"></i></button>
        <!--toggle button end-->
        <!--logo -->
...
?>  
            <li class="dropdown head-dpdn">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><img src="assets/images/bell-solid.svg" style="height:31px; width:31px;"><span class="badge blue"><?php echo $num;?></span></a>
...
<?php }} else {?>
    <a class="dropdown-item" href="all-appointment.php">No New Appointment Received</a>
        ...
        <div class="profile_details" style="width: 191px;">  
        <?php
            ...
            <li class="dropdown profile_details_drop">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                <div class="profile_img"> 
                  <span class="prfil-img"><img src="assets/images/download (1).png" alt="" width="50" height="60"> </span> 
                  <div class="user-name">
