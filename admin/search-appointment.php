...
<html>
<head>
<title>KSMS || Search Appointment</title>
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							 ...
							 <div class="form-group" style="height: 400px;"> <label for="exampleInputEmail1" style="
    color: white;
    margin-bottom: 24px;">Search by Appointment Number :-</label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control">
						
							<br>
							  <button type="submit" name="search" class="btn btn-primary btn-sm" style="
    margin-top: 67px;
    margin-left: 606px;
    font-size: 17px;
    width: 83px;
