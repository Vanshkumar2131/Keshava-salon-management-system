...
<head>
    ...
    <title> Keshava Salon Management System || Contact Page</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="widget widget-contact card" style="
    width: 388px; height:367px;">
    <span class="top"></span>
...
?>
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                            <div class="well-block card" style="
    width: unset;
    border-radius: 10px;
    height: 367px;
    background:#333333;">
